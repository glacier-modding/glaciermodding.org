...
```json
{"rootEntity":"cafe704aaa4b21c5","data":{"cafe704aaa4b21c5":{"parent":"22ea5f8267450642","name":"FX_Hitman_Wet_Logic_Character","factory":"[assembly:/_pro/effects/templates/water/fx_water_hitman_wet_logic.template?/fx_hitman_wet_logic_character.entitytemplate].pc_entitytype","blueprint":"[assembly:/_pro/effects/templates/water/fx_water_hitman_wet_logic.template?/fx_hitman_wet_logic_character.entitytemplate].pc_entityblueprint","properties":{"HeadMaterialToOverride":{"type":"ZRuntimeResourceID","value":{"resource":"[assembly:/_pro/characters/assets/_sourcefiles/male_reg_heads_unique/materials/male_reg_head_47_s3.mi].pc_mi","flag":"5F"}},"HeadMaterialOverride":{"type":"TArray<SEntityTemplateReference>","value":[],"postInit":true}},"events":{"HitmanWetness":{"T":["cafe7713b2d0cc7f","cafe12a9bd56da15","cafea848f0bc31e6","cafecc20e8c149df","cafe714de5ad0557"]}}},"cafecc20e8c149df":{"parent":"cafe704aaa4b21c5","name":"Lerp roughness fabric","factory":"[modules:/zmathlerp.class].pc_entitytype","blueprint":"[modules:/zmathlerp.class].pc_entityblueprint","properties":{"m_A":{"type":"float32","value":0.0},"m_fT":{"type":"float32","value":0.0},"m_B":{"type":"float32","value":0.4}},"events":{"Lerp":{"ConstantVector1D_14_Value":[]}}},"cafea848f0bc31e6":{"parent":"cafe704aaa4b21c5","name":"Lerp bumpmap","factory":"[modules:/zmathlerp.class].pc_entitytype","blueprint":"[modules:/zmathlerp.class].pc_entityblueprint","properties":{"m_A":{"type":"float32","value":0},"m_fT":{"type":"float32","value":0.0},"m_B":{"type":"float32","value":0.6}},"events":{"Lerp":{"ConstantVector1D_06_Value":[]}}},"cafe714de5ad0557":{"parent":"cafe704aaa4b21c5","name":"Lerp roughness other","factory":"[modules:/zmathlerp.class].pc_entitytype","blueprint":"[modules:/zmathlerp.class].pc_entityblueprint","properties":{"m_A":{"type":"float32","value":0.0},"m_fT":{"type":"float32","value":0.0},"m_B":{"type":"float32","value":0.4}},"events":{"Lerp":{"ConstantVector1D_04_Value":[]}}},"cafe7713b2d0cc7f":{"parent":"cafe704aaa4b21c5","name":"Lerp albedo","factory":"[modules:/zmathlerp.class].pc_entitytype","blueprint":"[modules:/zmathlerp.class].pc_entityblueprint","properties":{"m_A":{"type":"float32","value":0.5},"m_fT":{"type":"float32","value":0.0},"m_B":{"type":"float32","value":0.2}},"events":{"Lerp":{"ConstantVector1D_01_Value":[]}}},"cafe12a9bd56da15":{"parent":"cafe704aaa4b21c5","name":"Lerp jacket albedo","factory":"[modules:/zmathlerp.class].pc_entitytype","blueprint":"[modules:/zmathlerp.class].pc_entityblueprint","properties":{"m_A":{"type":"float32","value":2},"m_fT":{"type":"float32","value":0.0},"m_B":{"type":"float32","value":1}},"events":{"Lerp":{"ConstantVector1D_01_Value":[]}}}}}
```
...
Like I mentioned only things made of fabric should be darker in the rain. So right click and copy the IDs of `hat_beanie_cuffed`, `Pants_Jeans_Skinny`, and `TShirt_CrewNeck_Cut_Jacket`, and put them into this array, separated by commas.

It should look something like this when you are done.

![Supplying the Lerp albedo entity](/img/suitmodding/newoutfit/lerp_albedo.png)

You will notice the jacket has its own albedo lerp. This is because its `ConstantVector1D_01_Value` starts at a much higher value (2, not 1). So if we step out of the rain the jacket's `ConstantVector1D_01_Value` will return to 1 and not 2, which is very dark. It's not uncommon to have to create multiple lerps, given that each value can be different for each body part.

Supply `Jacket_Bomber_Open`'s entity ID into `Lerp jacket albedo`s event.

With the `Lerp albedo`s supplied let's continue with `Lerp bumpmap`. The property for this lerp is `ConstantVector1D_06_Value` which controls how strong the normal map is.
